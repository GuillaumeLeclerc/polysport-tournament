...
<div class="demo-updates mdl-card mdl-shadow--4dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
  ...
  <div class="mdl-card__actions mdl-card--border">
    <a href="#" @click.stop="this.mode='groups'" class="mdl-button mdl-button--raised mdl-js-button mdl-js-ripple-effect mdl-color-text--teal-400">Groups</a>
    <a href="#" @click.stop="this.mode='tree'" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-color-text--teal-400">Final Tree</a>
  </div>
</div>

<div class="demo-updates notification mdl-card mdl-shadow--2dp mdl-cell mdl-cell--6-col mdl-cell--6-col-tablet mdl-cell--6-col-desktop" v-for="group in tournament.groupStats">
